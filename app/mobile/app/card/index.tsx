/**
 * My Health Card Screen
 * Visual representation of the Health Card.
 * Allows user to view QR, view details, and download.
 */
...
export default function MyCardScreen() {
  ...
  const handleDownload = () => {
    // Simulate downloading/saving the card
    Alert.alert('Card Downloaded', 'Your Health Card has been saved to your device gallery.');
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.cardTop}>
            ...
            <View style={styles.cardTopRight}>
              ...
              <Text style={styles.cardType}>Primary</Text>
            </View>
          </View>
          
          <View style={styles.cardMiddle}>
            <Text style={styles.cardNumberLabel}>MedCred ID</Text>
            <Text style={styles.cardNumber}>{user.id}</Text>
          </View>
        ...
        <View style={styles.actionsContainer}>
          <TouchableOpacity style={styles.actionBtn} onPress={() => router.push('/card/qr')}>
          ...
          <TouchableOpacity style={styles.actionBtn} onPress={() => router.push('/card/details')}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Present this digital card or the QR code at any of our network hospitals to avail your cashless health benefits. No physical card is required.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  cardContainer: {
    ...
    minHeight: 220, // remove aspect ratio to prevent clipping
    justifyContent: 'space-between',
    overflow: 'hidden',
  },
  cardCircle1: {
